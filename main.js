document.addEventListener("rssDataLoaded", function() {
...
function main() {
  ...
  document.querySelectorAll('.Carousel').forEach(($carousel) => {
    ...
    const $cards = Array.from($carousel.querySelectorAll('.Card Card--overlay Card--square'));
...
/**
const styleToggle = document.getElementById('toggle-theme');

styleToggle.addEventListener("change", function() {
  const mainStyle = document.getElementsByTagName('body');
  console.log('checked box');
  console.log(mainStyle);
  
  if (styleToggle.checked) {
    mainStyle.style.backgroundColor = 'black';//'linear-gradient(90deg, #4b6cb7 0%, #182848 100%);'
  } else {
